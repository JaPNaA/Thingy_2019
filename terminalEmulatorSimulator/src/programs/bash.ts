...
class Bash extends Program {
    private programStdin: ReadStream<string>;
    ...
    private async listenForCommands() {
        while (true) {
            this.stdout.write("$ ");
    ...
    private async stringToCommandAndArgs(str: string) {
        const firstSpaceIndex = str.indexOf(' ');

        let command: string, argsString: string;
    ...
    private async stringToArgs(strin: string) {
        const args = [];
        let str = strin + "\n";
        let inQuotes = false;
        let escaped = false;
    ...
    private findProgram(command: string) {
